      ...
      <header className="brand">
        <a href="#" className="brand-link" aria-label="Navireq home">
          ...
          >
            ...
            <path
              d="M 20 38 L 32 26 L 36 26 L 64 60 L 64 26 L 80 26 L 80 70 L 68 82 L 64 82 L 36 48 L 36 82 L 20 82 Z"
              fill="#FFFFFF"
            />
      ...
      <main className="page-content">
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <svg viewBox="0 0 24 24">
                  <path
                    fill="#4285F4"
                    d="M21.35 12.2c0-.7-.06-1.23-.2-1.8H12v3.4h5.37a4.6 4.6 0 0 1-1.98 3.01v2.5h3.2c1.88-1.74 2.96-4.3 2.96-7.11Z"
                  />
                  <path
                    fill="#34A853"
                    d="M12 21.75c2.69 0 4.95-.89 6.6-2.44l-3.2-2.5c-.89.6-2.02.96-3.4.96-2.6 0-4.8-1.75-5.59-4.1H3.1v2.58A9.96 9.96 0 0 0 12 21.75Z"
                  />
                  <path
                    fill="#FBBC05"
                    d="M6.41 13.67A5.99 5.99 0 0 1 6.1 12c0-.58.11-1.15.31-1.67V7.75H3.1A9.95 9.95 0 0 0 2.08 12c0 1.53.37 2.98 1.02 4.25l3.31-2.58Z"
                  />
                  <path
                    fill="#EA4335"
                    d="M12 6.23c1.47 0 2.79.5 3.83 1.49l2.87-2.87C16.95 3.26 14.69 2.25 12 2.25a9.96 9.96 0 0 0-8.9 5.5l3.31 2.58c.79-2.35 2.99-4.1 5.59-4.1Z"
                  />
                </svg>
              </span>
            ...
            >
              <span
                className="social-icon microsoft-icon"
                aria-hidden="true"
              >
                <svg viewBox="0 0 24 24">
                  <rect
